  ...
  return (
    <section className="max-container">
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            I've worked in different roles with each one bringing me into
            contact with interesting technologies. Here's the rundown:
          </p>
        </div>
                ...
                icon={
                  <div className="flex justify-center items-center w-full h-full">
                    <img
                      ...
                      className="w-[60%] h-[60%] object-contain rounded-[5px]"
                    />
                  </div>
                }
                iconStyle={{
